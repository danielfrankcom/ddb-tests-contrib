...
ERROR_PRECEDENCE_TESTS: list[CollStatsTestCase] = [
    CollStatsTestCase(
        ...
        msg="type error (14) should fire before view error (166)",
    ),
    CollStatsTestCase(
        ...
        error_code=COLLSTATS_NON_EMPTY_OPTION_ERROR,
        msg="non-empty count error (31170) should fire before view error (166)",
    ),
    CollStatsTestCase(
        "type_error_over_nonexistent",
        pipeline=[{"$collStats": {"count": "bad"}}],
        error_code=TYPE_MISMATCH_ERROR,
        msg="type error (14) should fire before non-existent error (26)",
    ),
    CollStatsTestCase(
        "non_empty_count_over_nonexistent",
        pipeline=[{"$collStats": {"count": {"x": 1}}}],
        error_code=COLLSTATS_NON_EMPTY_OPTION_ERROR,
        msg="non-empty count error (31170) should fire before non-existent error (26)",
    ),
    CollStatsTestCase(
